...
class RenameProject extends ProjectSimulation {
  private var projectRenamed: String = "GATLING_RENAME_TEST_RENAMED"
  ...
  override def replaceOverride(in: String): String = {
    val next = replaceKeyWith("rename_var", projectRenamed, in)
