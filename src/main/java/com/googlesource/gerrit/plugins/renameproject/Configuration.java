...
public class Configuration {
  ...
  private static final String ALLOW_PROJECTS_WITH_CHANGES = "allowProjectsWithChanges";
  ...
  private final boolean allowProjectsWithChanges;
  ...
  public Configuration(PluginConfigFactory pluginConfigFactory, @PluginName String pluginName) {
    ...
    allowProjectsWithChanges = cfg.getBoolean(ALLOW_PROJECTS_WITH_CHANGES, true);
    urls =
  ...
  public boolean isAllowProjectsWithChanges() {
    return allowProjectsWithChanges;
  }
}
