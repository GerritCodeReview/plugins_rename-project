...
public final class RenameCommand extends SshCommand {
  ...
  protected RenameCommand(
      RenameProject renameProject, ProjectCache projectCache, Provider<CurrentUser> self) {
  ...
  public void run() throws Exception {
    try {
      ...
      ProjectResource rsrc =
          new ProjectResource(projectCache.get(new Project.NameKey(projectControl)), self.get());
