...
import com.googlesource.gerrit.plugins.renameproject.Configuration.HttpClientConfiguration;
...
class HttpClientProvider implements Provider<CloseableHttpClient> {
  ...
  private RequestConfig customRequestConfig() {
    return RequestConfig.custom()
        .setConnectTimeout(cfg.httpClient().connectionTimeout())
        .setSocketTimeout(cfg.httpClient().socketTimeout())
        .setConnectionRequestTimeout(cfg.httpClient().connectionTimeout())
        .build();
  }
  ...
  private BasicCredentialsProvider buildCredentials() {
    ...
    HttpClientConfiguration httpCfg = cfg.httpClient();
    creds.setCredentials(
        AuthScope.ANY, new UsernamePasswordCredentials(httpCfg.user(), httpCfg.password()));
    return creds;
  }
