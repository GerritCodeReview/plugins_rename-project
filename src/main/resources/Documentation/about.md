...
to either rename the project on the replica side manually or delete the original (not renamed)
project on the replica side and then trigger full replication on the renamed project from the
primary side.
