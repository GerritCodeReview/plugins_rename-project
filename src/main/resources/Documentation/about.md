...
1. Start replication on the renamed project from the primary side. For more information on how to
refer [replication start command](../../replication/Documentation/cmd-start.md)
