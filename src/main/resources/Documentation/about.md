...
to consider the following steps:
 1. Start replication on the renamed project from the primary side. For more information on refer 
 [replication start command](../../replication/Documentation/cmd-start.md)
 2. Confirm that renamed project is replicated.
 3. Delete the original (not renamed) project on the replica side.
